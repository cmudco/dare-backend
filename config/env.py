...
BACKGROUND_MODEL = os.getenv("BACKGROUND_MODEL", "gpt-5.6-luna")
...
DOCUMENT_ENRICHMENT_CONCURRENCY = max(
    1, min(env.int("DOCUMENT_ENRICHMENT_CONCURRENCY", default=2), 4)
)
DOCUMENT_ENRICHMENT_MAX_FIGURES = env.int("DOCUMENT_ENRICHMENT_MAX_FIGURES", default=40)
DOCUMENT_OCR_AUTO_PAGE_LIMIT = env.int("DOCUMENT_OCR_AUTO_PAGE_LIMIT", default=10)
DOCUMENT_OCR_MAX_PAGE_LIMIT = env.int("DOCUMENT_OCR_MAX_PAGE_LIMIT", default=100)
DOCUMENT_OCR_ESTIMATED_INPUT_TOKENS_PER_PAGE = env.int(
    "DOCUMENT_OCR_ESTIMATED_INPUT_TOKENS_PER_PAGE", default=5000
)
DOCUMENT_OCR_ESTIMATED_OUTPUT_TOKENS_PER_PAGE = env.int(
    "DOCUMENT_OCR_ESTIMATED_OUTPUT_TOKENS_PER_PAGE", default=2000
)
