...
This file provides guidance to AI coding agents working with the Django backend of the DARE
project. It is read directly by Codex and other tools that follow the `AGENTS.md` convention, and
by Claude Code through the import in `CLAUDE.md`.
