...
class AccessCodeGroupAdmin(admin.ModelAdmin):
    list_display = ('access_code', 'scope', 'default_role', 'model_group', 'initial_wallet_credit', 'usage_display', 'expiration_status', 'is_active', 'user_count', 'created_at')
    list_filter = ('is_active', 'scope', 'default_role', 'created_at', 'model_group')
    ...
    fieldsets = (
        ...
        (_('Role Assignment'), {
            'fields': ('default_role',),
            'description': 'Role assigned to users who register with this access code. CREATOR role allows creating bots in SocraticBots.'
        }),
        (_('Model Access'), {
            'fields': ('model_group',),
...
class UserAdmin(DjangoUserAdmin):
    ...
    add_fieldsets = (
        (
            ...
            {
                "classes": ("wide",),
                "fields": ("email", "password1", "password2", "platform_role", "vector_db", "auth_source", "is_dare_accessible", "is_socratic_bots_accessible", "is_superuser", "is_staff", "is_active"),
            },
        ),
    )
    ...
    list_filter = ("is_staff", "is_superuser", "is_active", "platform_role", LastLoginFilter, "vector_db", "access_code_group", "auth_source", "is_dare_accessible", "is_socratic_bots_accessible")
