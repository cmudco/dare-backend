# Generated by Django 5.1.12 on 2025-09-28 13:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        # Create the node data models with proper abstract inheritance
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "title",
                    models.CharField(
                        help_text="Workflow title", max_length=255
                    ),
                ),
                (
                    "description",
                    models.TextField(help_text="Workflow description"),
                ),
                (
                    "mode",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        blank=True, help_text="Execution status", max_length=20
                    ),
                ),
                (
                    "response",
                    models.TextField(
                        blank=True, help_text="Step execution response"
                    ),
                ),
                (
                    "error",
                    models.TextField(
                        blank=True, help_text="Error message if step failed"
                    ),
                ),
            ],
            options={
        ...
        # Add workflow node and edge models
        migrations.CreateModel(
            name="WorkflowNode",
            fields=[
                (
                ...
                (
                    "position_x",
                    models.FloatField(help_text="X coordinate (node.position.x)"),
                ),
                (
                    "position_y",
                    models.FloatField(help_text="Y coordinate (node.position.y)"),
                ),
                (
                    "width",
                    models.FloatField(
                ...
                (
                    "selected",
                    models.BooleanField(
                        default=False, help_text="Selection state (node.selected)"
                    ),
                ),
                (
                    "dragging",
                    models.BooleanField(
                        default=False, help_text="Current drag status (node.dragging)"
                    ),
                ),
                (
                    "draggable",
                    models.BooleanField(
                        default=True, help_text="Can node be dragged (node.draggable)"
                    ),
                ),
                (
                    "selectable",
                    models.BooleanField(
                        default=True, help_text="Can node be selected (node.selectable)"
                    ),
                ),
                (
                    "connectable",
                ...
                (
                    "deletable",
                    models.BooleanField(
                        default=True, help_text="Can node be deleted (node.deletable)"
                    ),
                ),
                (
                    "hidden",
                    models.BooleanField(
                        default=False, help_text="Node visibility (node.hidden)"
                    ),
                ),
                (
                    "source_position",
                ...
                (
                    "z_index",
                    models.IntegerField(
                        default=0, help_text="Rendering layer (node.zIndex)"
                    ),
                ),
                (
                    "drag_handle",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "source",
                    models.CharField(
                        help_text="Source node ID (edge.source)", max_length=255
                    ),
                ),
                (
                    "target",
                    models.CharField(
                        help_text="Target node ID (edge.target)", max_length=255
                    ),
                ),
                (
                    "source_handle",
                ...
                (
                    "data",
                    models.JSONField(
                        default=dict, help_text="Arbitrary edge data (edge.data)"
                    ),
                ),
                (
                    "selected",
                    models.BooleanField(
                        default=False, help_text="Selection state (edge.selected)"
                    ),
                ),
                (
                    "animated",
                    models.BooleanField(
                        default=False, help_text="Animation state (edge.animated)"
                    ),
                ),
                (
                    "hidden",
                    models.BooleanField(
                        default=False, help_text="Edge visibility (edge.hidden)"
                    ),
                ),
                (
                    "deletable",
                    models.BooleanField(
                        default=True, help_text="Can edge be deleted (edge.deletable)"
                    ),
                ),
                (
                    "selectable",
                    models.BooleanField(
                        default=True, help_text="Can edge be selected (edge.selectable)"
                    ),
                ),
                (
                    "z_index",
                    models.IntegerField(
                        default=0, help_text="Rendering layer (edge.zIndex)"
                    ),
                ),
                (
                    "label",
                    models.TextField(blank=True, help_text="Edge label text (edge.label)"),
                ),
                (
                    "style",
                    models.JSONField(
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(
                fields=("workflow", "node_id"), name="unique_workflow_node"
            ),
        ),
        migrations.AddConstraint(
            model_name="workflowedge",
            constraint=models.UniqueConstraint(
                fields=("workflow", "edge_id"), name="unique_workflow_edge"
            ),
        ),
        # Add the new viewport fields to workflow
        migrations.AddField(
            model_name="workflow",
            name="viewport_x",
            field=models.FloatField(
                default=0.0, help_text="Viewport X position"
            ),
        ),
        migrations.AddField(
            model_name="workflow",
            name="viewport_y",
            field=models.FloatField(
                default=0.0, help_text="Viewport Y position"
            ),
        ),
        migrations.AddField(
            model_name="workflow",
            name="viewport_zoom",
            field=models.FloatField(
                default=1.0, help_text="Viewport zoom level"
            ),
        ),
    ]