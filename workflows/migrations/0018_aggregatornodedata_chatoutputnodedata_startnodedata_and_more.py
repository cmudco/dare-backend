# Generated by Django 5.1.11 on 2025-09-24 16:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "response",
                    models.TextField(blank=True, help_text="Step execution response"),
                ),
                (
                    "error",
                    models.TextField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "step_number",
                    models.PositiveIntegerField(help_text="Step order in workflow"),
                ),
                (
                    "max_tokens",
                    models.PositiveIntegerField(
                        default=2048, help_text="Maximum tokens for LLM response"
                    ),
                ),
                (
                    "temperature",
                ...
                (
                    ...
                    models.BooleanField(
                        default=False, help_text="Inherit files from previous step"
                    ),
                ),
                (
                    "use_previous_step_embeddings",
                    models.BooleanField(
                        default=False, help_text="Inherit embeddings from previous step"
                    ),
                ),
                (
                    "content_files",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "label",
                    models.TextField(
                        blank=True, help_text="Edge label text (edge.label)"
                    ),
                ),
                (
                    "style",
